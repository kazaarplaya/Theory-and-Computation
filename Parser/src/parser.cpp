...
void Parser::buildParsingTable(){
    ...
    defaultActions[35] = Action(ActionType::REDUCE, 67);
    defaultActions[36] = Action(ActionType::REDUCE, 68);
    defaultActions[37] = Action(ActionType::REDUCE, 69);
    defaultActions[42] = Action(ActionType::REDUCE, 57);
    defaultActions[43] = Action(ActionType::REDUCE, 61);
    defaultActions[44] = Action(ActionType::REDUCE, 66);
    defaultActions[46] = Action(ActionType::REDUCE, 25);
    defaultActions[49] = Action(ActionType::REDUCE, 21);
    defaultActions[50] = Action(ActionType::REDUCE, 53);
    defaultActions[52] = Action(ActionType::REDUCE, 18);
    defaultActions[53] = Action(ActionType::REDUCE, 17);
    defaultActions[56] = Action(ActionType::REDUCE, 58);
    defaultActions[60] = Action(ActionType::REDUCE, 62);
    ...
    defaultActions[66] = Action(ActionType::REDUCE, 70);
    defaultActions[67] = Action(ActionType::REDUCE, 61);
    defaultActions[68] = Action(ActionType::REDUCE, 61);
    defaultActions[69] = Action(ActionType::REDUCE, 66);
    defaultActions[70] = Action(ActionType::REDUCE, 66);
    defaultActions[71] = Action(ActionType::REDUCE, 66);
    ...
    defaultActions[94] = Action(ActionType::REDUCE, 59);
    defaultActions[95] = Action(ActionType::REDUCE, 60);
    defaultActions[96] = Action(ActionType::REDUCE, 63);
    defaultActions[97] = Action(ActionType::REDUCE, 64);
    defaultActions[98] = Action(ActionType::REDUCE, 65);
    defaultActions[100] = Action(ActionType::REDUCE, 40);
    defaultActions[104] = Action(ActionType::REDUCE, 46);
    defaultActions[106] = Action(ActionType::REDUCE, 55);
    ...
    defaultActions[113] = Action(ActionType::REDUCE, 54);
    ...
    defaultActions[129] = Action(ActionType::REDUCE, 56);
    ...
    defaultActions[143] = Action(ActionType::REDUCE, 52);
